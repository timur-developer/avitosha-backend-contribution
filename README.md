...
Репозиторий содержит мою личную работу в проекте «Авитоша» (кейс 1) для хакатона Авито. Я отвечал за **фундамент Go-приложения**, **безопасный контур авторизации и управления сессиями**, **retention и reward-механики**, а также **production-деплой приложения в Yandex Cloud**.
